/datum/data/vending_product
	...
	var/product_discountedcost

	var/static/list/product_name_cache = list()

	New(productpath, amount=0, cost=0, hidden=0, discount=0)
		...
		src.product_hidden = hidden  //If discountedcost defaults to 0 it would undermine the restriction of high-priced items. So discountedcost is indirectly calulated.
		src.product_discountedcost = cost-discount  //Also if cost < discount, people can get money for buying stuff. -TheGrimSleeper
...
/obj/machinery/vending
	...
	var/discount_active = 0  /// Is the machine hacked so its inventory is on sale?
...
/obj/machinery/vending/coffee
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/coffee", 25, cost=1, discount=1)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/tea", 10, cost=1, discount=1)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/xmas", 10, cost=1, discount=1)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/chickensoup", 10, cost=3, discount=2)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/weightloss_shake", 10, cost=5, discount=3)
...
/obj/machinery/vending/snack
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/snacks/candy", 20, cost=2, discount=2)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/snacks/chips", 20, cost=2, discount=2)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/snacks/donut", 20, cost=3, discount=2)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/snacks/fries", 20, cost=3, discount=2)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/noodlecup", 20, cost=2, discount=1)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/snacks/burrito", 20, cost=3, discount=1)
        // Go away, every flavor beans...
		//product_list += new/datum/data/vending_product("/obj/item/kitchen/everyflavor_box", 20, cost=15, discount=5)
...
/obj/machinery/vending/cigarette
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/cigpacket", 20, cost=10, discount=6)
		product_list += new/datum/data/vending_product("/obj/item/cigpacket/nicofree", 20, cost=15, discount=8)
		product_list += new/datum/data/vending_product("/obj/item/cigpacket/propuffs", 20, cost=20, discount=10)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/patch/nicotine", 20, cost=15, discount=8)
		product_list += new/datum/data/vending_product("/obj/item/matchbook", 15, cost=5, discount=3)
		product_list += new/datum/data/vending_product("/obj/item/zippo", 5, cost=35, discount=16)

		product_list += new/datum/data/vending_product("/obj/item/device/igniter", rand(1, 6), hidden=1)
		//product_list += new/datum/data/vending_product("/obj/item/cigpacket/random", rand(0, 1), hidden=1, cost=45, discount=15) // A mass-produceable source of every reagent in the game is just a bad idea (compare with snack machine & beans).
...
/obj/machinery/vending/medical_public
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/patch/mini/bruise", 5, cost=50, discount=21)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/patch/mini/burn", 5, cost=50, discount=21)
		product_list += new/datum/data/vending_product("/obj/item/device/healthanalyzer", 2, cost=80, discount=46)
		product_list += new/datum/data/vending_product("/obj/item/bandage", 5, cost=45)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/emergency_injector/charcoal", 5, cost=75, discount=41)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/pill/epinephrine", 5, cost=130, discount=66)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/emergency_injector/spaceacillin", 2, cost=110, discount=56)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/emergency_injector/antihistamine", 2, cost=70, discount=36)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/pill/salicylic_acid", 10, cost=65, discount=36)

		product_list += new/datum/data/vending_product("/obj/item/device/healthanalyzer_upgrade", rand(0, 2), hidden=1, cost=25, discount=20)
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/patch/mini/synthflesh", rand(0, 5), hidden=1, cost=95, discount=55)
		if (prob(5))
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/pill/bathsalts", 1, hidden=1, cost=140, discount=40)

		if (prob(15))
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/coffee", rand(1,5), hidden=1, cost=2, discount=2)
		else
...
/obj/machinery/vending/cola
	...
	red
		...
		create_products()
			..()
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/red", 20, cost=2, discount=2)
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/pink", 20, cost=2, discount=2)
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/lime", 20, cost=5, discount=3)
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/grones", 20, cost=5, discount=3)
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/bottledwater", 20, cost=10, discount=6)
	...
	blue
		...
		create_products()
			..()
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/blue", 20, cost=2, discount=2)
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/orange", 20, cost=5, discount=2)
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/spooky", 20, cost=2, discount=2)
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/spooky2",20, cost=2, discount=2)
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/food/drinks/bottle/bottledwater", 20, cost=10, discount=6)
...
/obj/machinery/vending/floppy
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/disk/data/floppy/computer3boot", 6, cost=60, discount=31)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/floppy/read_only/terminal_os", 6, cost=40, discount=21)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/floppy/read_only/network_progs", 4, cost=100, discount=51)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/floppy/read_only/medical_progs", 2, cost=35, discount=21)

		product_list += new/datum/data/vending_product("/obj/item/disk/data/floppy/read_only/security_progs", 2, cost=100, hidden=1, discount=31)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/floppy/read_only/communications", 2, cost=200, hidden=1, discount=111)
...
/obj/machinery/vending/pda //cogwerks: vendor to clean up the pile of PDA carts a bit
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/device/pda2", 10, cost=100, discount=51)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/cartridge/atmos", 2, cost=40, discount=21)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/cartridge/medical", 2, cost=40, discount=21)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/cartridge/toxins", 2, cost=50, discount=26)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/cartridge/botanist", 2, cost=40, discount=11)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/cartridge/diagnostics", 2, cost=70, discount=36)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/cartridge/game_codebreaker", 4, cost=25, discount=20)
		product_list += new/datum/data/vending_product("/obj/item/device/pda_module/flashlight/high_power", 2, cost=100, discount=51)

		product_list += new/datum/data/vending_product("/obj/item/disk/data/cartridge/security", 1, cost=80, hidden=1, discount=36)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/cartridge/head", 1, cost=100, hidden=1, discount=41)
		product_list += new/datum/data/vending_product("/obj/item/disk/data/cartridge/clown", 1, cost=200, hidden=1, discount=0)
...
/obj/machinery/vending/book //cogwerks: eventually this oughta have some of the wiki job guides available in it
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/paper/engine", 2, cost=20, discount=20)
		product_list += new/datum/data/vending_product("/obj/item/paper/Toxin", 2, cost=20, discount=20)
		product_list += new/datum/data/vending_product("/obj/item/paper/book/cookbook", 2, cost=30, discount=25)
		product_list += new/datum/data/vending_product("/obj/item/paper/book/dwainedummies", 2, cost=60, discount=35)
		product_list += new/datum/data/vending_product("/obj/item/paper/book/guardbot_guide", 2, cost=50, discount=15)
		product_list += new/datum/data/vending_product("/obj/item/paper/book/hydroponicsguide", 2, cost=40, discount=39)
		product_list += new/datum/data/vending_product("/obj/item/paper/book/monster_manual", 2, cost=30, discount=29)
		product_list += new/datum/data/vending_product("/obj/item/paper/Cloning", 2, cost=30, discount=19)
		product_list += new/datum/data/vending_product("/obj/item/paper/book/medical_guide", 2, cost=30, discount=19)
		product_list += new/datum/data/vending_product("/obj/item/paper/book/minerals", 2, cost=10, discount=1)

		product_list += new/datum/data/vending_product("/obj/item/paper/book/the_trial", 1, cost=80, hidden=1, discount=41)
		product_list += new/datum/data/vending_product("/obj/item/paper/book/critter_compendium", 1, cost=100, hidden=1, discount=91)
...
/obj/machinery/vending/hydroponics/mean_solarium_bullshit
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/device/key/cheget",1, 954, 1, 0) //donno what this is, but no discounts! -TheGrimSleeper
...
/obj/machinery/vending/fortune
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/paper/thermal/fortune", 25, cost=10, discount=6)
		product_list += new/datum/data/vending_product("/obj/item/playing_cards/tarot", 5, cost=25, discount=15)
		product_list += new/datum/data/vending_product("/obj/item/paper/card_manual", 5, cost=1, discount=1)
...
/obj/machinery/vending/chem
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/vending/vial/random", 1, cost = rand(1000, 10000), discount=0)
		var/lock1 = rand(1, 9)
		for (var/i = 0, i < lock1, i++) // this entire thing is just random luck
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/vending/vial/random", 1, cost = rand(1000, 10000), discount=0)

		product_list += new/datum/data/vending_product("/obj/item/reagent_containers/vending/bag/random", 1, cost = rand(1000, 10000), discount=0)
		var/lock2 = rand(1, 9)
		for (var/i = 0, i < lock2, i++) // so we'll add a random amount to each machine
			product_list += new/datum/data/vending_product("/obj/item/reagent_containers/vending/bag/random", 1, cost = rand(1000, 10000), discount=0)

		product_list += new/datum/data/vending_product("/obj/item/cigpacket/random", 1, cost = rand(1000, 10000), hidden=1, discount=0)
		var/lock3 = rand(1, 9)
...
/obj/machinery/vending/cards
	...
	create_products()
		..()
		product_list += new/datum/data/vending_product("/obj/item/paper/card_manual", 10, cost=1, discount=1)
		product_list += new/datum/data/vending_product("/obj/item/card_box/trading", 5, cost=60, discount=51)
		product_list += new/datum/data/vending_product("/obj/item/card_box/booster", 20, cost=20, discount=0) //this is how they get you -TheGrimSleeper
		product_list += new/datum/data/vending_product("/obj/item/card_box/suit", 10, cost=15, discount=9)
		product_list += new/datum/data/vending_product("/obj/item/card_box/tarot", 5, cost=25, discount=9)
	...
	if (src.product_list.len == 0)
		...
		for (var/datum/data/vending_product/R in src.product_list)
			...
			if (R.product_amount > 0)
				src.vending_HTML += "<a href='byond://?src=\ref[src];vend=\ref[R]'>Vend[(src.pay && src.getprice(R)) ? " ($[src.getprice(R)])" : null]</A>"
			else
...
/obj/machinery/vending/proc/generate_wire_HTML()
	...
	for (var/wiredesc in vendwires)
		var/is_uncut = src.wires & VendorWireColorToFlag[vendwires[wiredesc]]
	...
	src.wire_HTML += "The enforcer-unit [(src.wires & src.discount_active) ? "looks angy" : "is active"]."
	...
	if ((usr.contents.Find(src) || (in_range(src, usr) && istype(src.loc, /turf))))
		...
		if ((href_list["vend"]) && (src.vend_ready))
			...
			if (src.pay)
				if (src.acceptcard && src.scan)
					...
					if (!account)
						...
						src.generate_HTML(1)
						return
					if (account.fields["current_money"] < src.getprice(R))
			...
			spawn(src.vend_delay)
				if (!pay || (src.credit >= src.getprice(R)) || (account && account.fields["current_money"] >= src.getprice(R))) //Conor12: Prevents credit hitting negative numbers if multiple items are bought at once.
					R.product_amount--
					...
					if (src.pay)
						if (src.acceptcard && src.scan && account)
							account.fields["current_money"] -= src.getprice(R)
						else
							src.credit -= src.getprice(R)
						wagesystem.shipping_budget += round(src.getprice(R) * profit) // cogwerks - maybe money shouldn't just vanish into the aether idk
...
/obj/machinery/vending/proc/isWireColorCut(var/wireColor)
	var/wireFlag = VendorWireColorToFlag[wireColor]
	return ((src.wires & wireFlag) == 0)

/obj/machinery/vending/proc/isWireCut(var/wireIndex)
	var/wireFlag = VendorIndexToFlag[wireIndex]
	return ((src.wires & wireFlag) == 0)

/obj/machinery/vending/proc/cut(var/wireColor)
	var/wireFlag = VendorWireColorToFlag[wireColor]
	var/wireIndex = VendorWireColorToIndex[wireColor]
	src.wires &= ~wireFlag
	switch(wireIndex)
		if(WIRE_EXTEND)
		...
		if(WIRE_DISCOUNT)
			src.discount_active = 1
			src.generate_HTML(1)
	src.generate_HTML(0, 1)

/obj/machinery/vending/proc/mend(var/wireColor)
	var/wireFlag = VendorWireColorToFlag[wireColor]
	var/wireIndex = VendorWireColorToIndex[wireColor] //not used in this function
	src.wires |= wireFlag
	switch(wireIndex)
//		if(WIRE_SCANID)
		if(WIRE_SHOCK)
...
/obj/machinery/vending/proc/getprice(var/datum/data/vending_product/R)		// This is right, right?
	if (src.discount_active)
		return R.product_discountedcost
	else
		return R.product_cost

/proc/RandomVendorWires() //why did all hackables use the APChacking code. That is sloppy! I am very cross! Totally stealing it. see also global.dm -TheGrimSleeper
	//to make this not randomize the wires, just set index to 1 and increment it in the flag for loop (after doing everything else).
	var/list/vendorwires = list(0, 0, 0, 0, 0)
	VendorIndexToFlag = list(0, 0, 0, 0, 0)
	VendorIndexToWireColor = list(0, 0, 0, 0, 0)
	VendorWireColorToIndex = list(0, 0, 0, 0, 0)
	var/flagIndex = 1
	for (var/flag=1, flag<32, flag+=flag) //question: why does this loop not increment liniarly? -TheGrimSleeper
		var/valid = 0
		while (!valid)
			var/colorIndex = rand(1, 5)
			if (vendorwires[colorIndex]==0)
				valid = 1
				vendorwires[colorIndex] = flag
				VendorIndexToFlag[flagIndex] = flag
				VendorIndexToWireColor[flagIndex] = colorIndex
				VendorWireColorToIndex[colorIndex] = flagIndex
		flagIndex+=1
	return vendorwires
